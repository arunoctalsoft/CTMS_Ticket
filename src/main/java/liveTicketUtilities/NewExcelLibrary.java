...
public static String path = System.getProperty("user.dir") + "\\src\\test\\resource\\TestDataLiveTicket.xlsx";
...
//	public  String path;
	...
	// returns the row count in a sheet
		public int getRowCount(String sheetName){
			...
			System.out.println("Current working directory in Java : " + number);
			return number;
			}
