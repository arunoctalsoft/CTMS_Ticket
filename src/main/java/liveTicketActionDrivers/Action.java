package liveTicketActionDrivers;
...
import liveTicketActionInterface.ActionInterface;
import liveTicketBase.BaseLiveTickets;

public class Action extends BaseLiveTickets implements ActionInterface {
	@Override
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "D:\\CTMSAutomationTesting\\Cliantha\\ScreenShots\\" + filename + "_" + dateName
				+ ".png";
		return destination;
	}
