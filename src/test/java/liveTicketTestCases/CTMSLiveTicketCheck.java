...
public class CTMSLiveTicketCheck {
	public static ExtentHtmlReporter htmlReporter;
	public WebDriver driver;
	public ExtentSparkReporter spark;
	public ExtentReports extent;
	public ExtentTest logger;
	int newticket, openticket, closeticket, cancelledticket, reopenticket, internalreviewticket, underreviewticket;
	String URL;
	...
	public void startReport() {
		...
		htmlReporter = new ExtentHtmlReporter(
				System.getProperty("user.dir") + "/Test-Output/ExtentReport/" + "CTMS_Tickets.html");
...
//driver.get("https://www.google.com/");
	...
	public void findCTMSLiveTickets(String Url, String ctms, CharSequence username, CharSequence password)
			throws InterruptedException {
		System.out.println("Client Name:"+ctms);
		driver.get(Url);
		URL=Url;
		Thread.sleep(2000);
		logger = extent.createTest("->" + ctms);
		Thread.sleep(2000);
		...
		newticket=Integer.parseInt(driver.findElement(By.cssSelector("#P278_NEW")).getAttribute("value"));
		Thread.sleep(1000);
		openticket=Integer.parseInt(driver.findElement(By.cssSelector("#P278_OPEN")).getAttribute("value"));
		Thread.sleep(1000);
		closeticket=Integer.parseInt(driver.findElement(By.cssSelector("#P278_CLOSE")).getAttribute("value"));
		Thread.sleep(1000);
		cancelledticket=Integer.parseInt(driver.findElement(By.cssSelector("#P278_CANCELLED")).getAttribute("value"));
		Thread.sleep(1000);
		reopenticket=Integer.parseInt(driver.findElement(By.cssSelector("#P278_REOPEN")).getAttribute("value"));
		Thread.sleep(1000);
		internalreviewticket=Integer.parseInt(driver.findElement(By.cssSelector("#P278_INTERNAL_REVIEW")).getAttribute("value"));
		Thread.sleep(1000);
		underreviewticket=Integer.parseInt(driver.findElement(By.cssSelector("#P278_UNDER_REVIEW")).getAttribute("value"));
		Thread.sleep(1000);
...
//		Thread.sleep(2000);
	...
	public void getResult(ITestResult result) throws Exception {
		// if (result.getStatus() == ITestResult.SUCCESS)
					...
					logger.log(Status.PASS, MarkupHelper.createLabel(" ReOpen Tickets:" + reopenticket, ExtentColor.RED));
					logger.log(Status.PASS, MarkupHelper.createLabel(" InternalReview Tickets:" + internalreviewticket, ExtentColor.BLUE));
					logger.log(Status.PASS, MarkupHelper.createLabel(" UnderReview Tickets:" + underreviewticket, ExtentColor.BLUE));
...
//							MarkupHelper.createLabel(result.getThrowable() + " - Test Case Passed", ExtentColor.GREEN));
					...
					if(newticket != 0||openticket != 0||reopenticket!=0||internalreviewticket!=0||underreviewticket!=0)
					{
					if (newticket != 0) {
						driver.findElement(By.xpath("//a[normalize-space()='Status']")).click();
						Thread.sleep(3000);
					...
					//if (closeticket != 0) {
					if (underreviewticket != 0) {
						driver.findElement(By.xpath("//a[normalize-space()='Status']")).click();
						Thread.sleep(3000);
						//driver.findElement(By.cssSelector("a[data-return-value='Close']")).click();
						driver.findElement(By.cssSelector("a[data-return-value='Under Review']")).click();
						Thread.sleep(2000);
						String screenshotPath = getScreenShot(driver, result.getName());
					...
					if (internalreviewticket != 0) {
						driver.findElement(By.xpath("//a[normalize-space()='Status']")).click();
						Thread.sleep(3000);
						//driver.findElement(By.cssSelector("a[data-return-value='Close']")).click();
						driver.findElement(By.cssSelector("a[data-return-value='Internal Review']")).click();
						Thread.sleep(2000);
						String screenshotPath = getScreenShot(driver, result.getName());
					...
					else if (newticket <= 0 && openticket <= 0 && reopenticket <= 0 && internalreviewticket<=0 && underreviewticket<=0) {
		//MarkupHelper is used to display the output in different colors
...
//				}
	...
	public static void SendEmail() throws EmailException {
		...
		attachment.setPath(
				"C:\\Users\\Octalsoft-86\\git\\repository\\CtmsLiveTicketCheck\\Test-Output\\ExtentReport\\CTMS_Tickets.html");
		...
		email1.setAuthenticator(new DefaultAuthenticator("anil.kasture@octalsoft.com", "Oct@86E86"));
