...
public class IWRSLiveTicketCheck {
	public static ExtentHtmlReporter htmlReporter;
	public WebDriver driver;
	public ExtentSparkReporter spark;
	public ExtentReports extent;
	public ExtentTest logger;
	int newticket, openticket, closeticket, reopenticket,cancelledticket, clientreviewticket, pendingticket;
	String URL;
	...
	public void startReport() {
		...
		htmlReporter = new ExtentHtmlReporter(
				System.getProperty("user.dir") + "/Test-Output/ExtentReport/" + "IWRS_Tickets.html");
...
//driver.get("https://www.google.com/");
	...
	@Test(dataProvider = "iwrscredentials", dataProviderClass = DataProviders.class)
	public void findIWRSLiveTickets(String Url, String iwrs, CharSequence username, CharSequence password)
			throws InterruptedException {
		System.out.println("Client Name:"+iwrs);
		driver.get(Url);
		URL=Url;
		Thread.sleep(2000);
		logger = extent.createTest("->" + iwrs);
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		newticket=Integer.parseInt(driver.findElement(By.cssSelector("#P78_NEW")).getAttribute("value"));
		Thread.sleep(1000);
		openticket=Integer.parseInt(driver.findElement(By.cssSelector("#P78_OPEN")).getAttribute("value"));
		Thread.sleep(1000);
		closeticket=Integer.parseInt(driver.findElement(By.cssSelector("#P78_CLOSE")).getAttribute("value"));
		Thread.sleep(1000);
		cancelledticket=Integer.parseInt(driver.findElement(By.cssSelector("#P78_CANCELLED")).getAttribute("value"));
		Thread.sleep(1000);
		reopenticket=Integer.parseInt(driver.findElement(By.cssSelector("#P78_REOPEN")).getAttribute("value"));
		Thread.sleep(1000);
		clientreviewticket=Integer.parseInt(driver.findElement(By.cssSelector("#P78_CLIENT_REVIEW")).getAttribute("value"));
		Thread.sleep(1000);
		pendingticket=Integer.parseInt(driver.findElement(By.cssSelector("#P78_PENDING")).getAttribute("value"));
		Thread.sleep(1000);
...
//		Thread.sleep(2000);
	...
	public void getResult(ITestResult result) throws Exception {
		// if (result.getStatus() == ITestResult.SUCCESS)
					...
					logger.log(Status.PASS, MarkupHelper.createLabel(" Client Review Tickets:" + clientreviewticket, ExtentColor.BLUE));
...
//							MarkupHelper.createLabel(result.getThrowable() + " - Test Case Passed", ExtentColor.GREEN));
					...
					if(newticket != 0||openticket != 0||reopenticket!=0||clientreviewticket!=0||pendingticket!=0)
					{
					if (newticket != 0) {
						driver.findElement(By.xpath("//a[normalize-space()='Status']")).click();
						Thread.sleep(2000);
					...
					//if (closeticket != 0) {
					if (clientreviewticket != 0) {
						driver.findElement(By.xpath("//a[normalize-space()='Status']")).click();
						Thread.sleep(2000);
						//driver.findElement(By.cssSelector("a[data-return-value='Close']")).click();
						driver.findElement(By.cssSelector("a[data-return-value='Client Review']")).click();
						Thread.sleep(2000);
						String screenshotPath = getScreenShot(driver, result.getName());
					...
					else if (newticket <= 0 && openticket <= 0 && reopenticket <= 0 && clientreviewticket<=0 && pendingticket<=0) {
		//MarkupHelper is used to display the output in different colors
